# Consuming PIMS Classic in Expo apps

Read `artifacts/pims-classic/docs/AGENTS.md` first. React Native does
...
`artifacts/pims-classic/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/pims-classic/tokens";
...
```tsx
import { nativeTheme } from "@workspace/pims-classic/lib/native-theme";
import { useColors } from "@workspace/pims-classic/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/pims-classic/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/pims-classic/components/native/badge";
import { Button } from "@workspace/pims-classic/components/native/button";
import { Card } from "@workspace/pims-classic/components/native/card";
```
...
Import and render
`@workspace/pims-classic/components/native/button`, then run Expo
