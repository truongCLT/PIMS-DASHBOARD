# Migrating web UI to PIMS Classic

Read `artifacts/pims-classic/docs/AGENTS.md` and
`artifacts/pims-classic/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/pims-classic/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/pims-classic/lib/utils`
- `@/hooks/use-toast` → `@workspace/pims-classic/hooks/use-toast`
