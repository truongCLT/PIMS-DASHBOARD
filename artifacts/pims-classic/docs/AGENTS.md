...
workspace package (`@workspace/pims-classic`): other artifacts depend
...
`@workspace/pims-classic/components/...`. Never use a `@/` alias inside
...
for `@workspace/pims-classic` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/pims-classic` as a `workspace:*` dependency,
run `pnpm install`, and import directly from this package.

Read only the guides required by the current task:

- Building or styling web UI: `artifacts/pims-classic/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/pims-classic/docs/consuming-expo.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/pims-classic/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/pims-classic/docs/migrating-expo.md`
