# Consuming 대우본사요청-예시2 in Expo apps

Read `artifacts/daewoo-hq-example-2/docs/AGENTS.md` first. React Native does
...
`artifacts/daewoo-hq-example-2/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/daewoo-hq-example-2/tokens";
...
```tsx
import { nativeTheme } from "@workspace/daewoo-hq-example-2/lib/native-theme";
import { useColors } from "@workspace/daewoo-hq-example-2/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/daewoo-hq-example-2/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/daewoo-hq-example-2/components/native/badge";
import { Button } from "@workspace/daewoo-hq-example-2/components/native/button";
import { Card } from "@workspace/daewoo-hq-example-2/components/native/card";
```
...
Import and render
`@workspace/daewoo-hq-example-2/components/native/button`, then run Expo
