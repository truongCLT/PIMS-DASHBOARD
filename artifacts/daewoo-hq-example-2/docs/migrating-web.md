# Migrating web UI to 대우본사요청-예시2

Read `artifacts/daewoo-hq-example-2/docs/AGENTS.md` and
`artifacts/daewoo-hq-example-2/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/daewoo-hq-example-2/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/daewoo-hq-example-2/lib/utils`
- `@/hooks/use-toast` → `@workspace/daewoo-hq-example-2/hooks/use-toast`
