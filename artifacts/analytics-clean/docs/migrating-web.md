# Migrating web UI to Analytics Clean

Read `artifacts/analytics-clean/docs/AGENTS.md` and
`artifacts/analytics-clean/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/analytics-clean/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/analytics-clean/lib/utils`
- `@/hooks/use-toast` → `@workspace/analytics-clean/hooks/use-toast`
