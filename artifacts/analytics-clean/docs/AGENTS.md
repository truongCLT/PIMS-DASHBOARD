...
workspace package (`@workspace/analytics-clean`): other artifacts depend
...
`@workspace/analytics-clean/components/...`. Never use a `@/` alias inside
...
for `@workspace/analytics-clean` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/analytics-clean` as a `workspace:*` dependency,
run `pnpm install`, and import directly from this package.

Read only the guides required by the current task:

- Building or styling web UI: `artifacts/analytics-clean/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/analytics-clean/docs/consuming-expo.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/analytics-clean/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/analytics-clean/docs/migrating-expo.md`
