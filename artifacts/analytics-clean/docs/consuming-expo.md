# Consuming Analytics Clean in Expo apps

Read `artifacts/analytics-clean/docs/AGENTS.md` first. React Native does
...
`artifacts/analytics-clean/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/analytics-clean/tokens";
...
```tsx
import { nativeTheme } from "@workspace/analytics-clean/lib/native-theme";
import { useColors } from "@workspace/analytics-clean/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/analytics-clean/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/analytics-clean/components/native/badge";
import { Button } from "@workspace/analytics-clean/components/native/button";
import { Card } from "@workspace/analytics-clean/components/native/card";
```
...
Import and render
`@workspace/analytics-clean/components/native/button`, then run Expo
