...
workspace package (`@workspace/aqua-glass`): other artifacts depend
...
`@workspace/aqua-glass/components/...`. Never use a `@/` alias inside
...
for `@workspace/aqua-glass` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/aqua-glass` as a `workspace:*` dependency,
run `pnpm install`, and import directly from this package.

Read only the guides required by the current task:

- Building or styling web UI: `artifacts/aqua-glass/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/aqua-glass/docs/consuming-expo.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/aqua-glass/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/aqua-glass/docs/migrating-expo.md`
