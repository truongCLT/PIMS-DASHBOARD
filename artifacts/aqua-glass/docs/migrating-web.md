# Migrating web UI to Aqua Glass

Read `artifacts/aqua-glass/docs/AGENTS.md` and
`artifacts/aqua-glass/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/aqua-glass/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/aqua-glass/lib/utils`
- `@/hooks/use-toast` → `@workspace/aqua-glass/hooks/use-toast`
