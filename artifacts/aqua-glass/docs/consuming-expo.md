# Consuming Aqua Glass in Expo apps

Read `artifacts/aqua-glass/docs/AGENTS.md` first. React Native does
...
`artifacts/aqua-glass/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/aqua-glass/tokens";
...
```tsx
import { nativeTheme } from "@workspace/aqua-glass/lib/native-theme";
import { useColors } from "@workspace/aqua-glass/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/aqua-glass/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/aqua-glass/components/native/badge";
import { Button } from "@workspace/aqua-glass/components/native/button";
import { Card } from "@workspace/aqua-glass/components/native/card";
```
...
Import and render
`@workspace/aqua-glass/components/native/button`, then run Expo
