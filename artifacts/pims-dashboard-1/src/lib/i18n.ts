...
import projectReportTabKo from "../locales/ko/projectReportTab.json";
import projectReportTabEn from "../locales/en/projectReportTab.json";
import projectReportTabVi from "../locales/vi/projectReportTab.json";
...
import saleCostTabKo from "../locales/ko/saleCostTab.json";
import saleCostTabEn from "../locales/en/saleCostTab.json";
import saleCostTabVi from "../locales/vi/saleCostTab.json";
...
import serviceReportTabKo from "../locales/ko/serviceReportTab.json";
import serviceReportTabEn from "../locales/en/serviceReportTab.json";
import serviceReportTabVi from "../locales/vi/serviceReportTab.json";
...
import pimsvinaSyncPreviewKo from "../locales/ko/pimsvinaSyncPreview.json";
import pimsvinaSyncPreviewEn from "../locales/en/pimsvinaSyncPreview.json";
import pimsvinaSyncPreviewVi from "../locales/vi/pimsvinaSyncPreview.json";
...
const NAMESPACES = [
  ...
  "photoPager", "pimsvinaSyncPreview", "profitChart", "projectCommentPanel", "projectDashboard",
  "projectDataEntryTab", "projectReportTab", "saleCostTab", "saleProfitTab", "salesChart", "serviceBudgetTab",
  "serviceCashflowTab", "serviceOutsourcingTab", "serviceProjectDashboard", "serviceReportTab",
  "sidebar",
];
