...
export function DashboardHeader() {
  ...
  return (
    <div style={{
      ...
      {/* Diagonal navy/blue decorative block (background layer) */}
      <div style={{
        position: "absolute",
        right: 0,
        top: 0,
        bottom: 0,
        width: "46%",
        background: "linear-gradient(115deg, var(--color-navy-mid) 0%, var(--color-primary-blue) 60%, var(--color-blue-bright) 100%)",
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <span style={{ fontSize: "12px", color: "var(--color-text-body)", fontWeight: "600" }}>프로젝트:</span>
          <select
            value={project}
        ...
        {/* Date filter */}
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <span style={{ fontSize: "12px", color: "var(--color-text-body)", fontWeight: "600" }}>조회 기간:</span>
          <div style={{
            display: "flex",
            alignItems: "center",
            border: "1px solid var(--color-card-border)",
            ...
            <input
              ...
              style={{
                ...
                outline: "none",
                fontSize: "12px",
                color: startDate ? "var(--color-text-body)" : "var(--color-text-muted)",
            ...
            <input
              ...
              style={{
                ...
                outline: "none",
                fontSize: "12px",
                color: endDate ? "var(--color-text-body)" : "var(--color-text-muted)",
                backgroundColor: "transparent",
                cursor: "pointer",
                width: "104px",
                padding: "3px 0",
        ...
        {/* View period */}
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <span style={{ fontSize: "12px", color: "var(--color-text-body)", fontWeight: "600" }}>조회 기준:</span>
          <select
            value={period}
        ...
        {/* Currency */}
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <span style={{ fontSize: "12px", color: "var(--color-text-body)", fontWeight: "600" }}>통화:</span>
          <select
            value={currency}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginLeft: "auto" }}>
          <span style={{ fontSize: "12px", color: "var(--color-text-body)", fontWeight: "600" }}>단위:</span>
          <div style={{
            width: "36px",
            height: "20px",
          ...
          <span style={{ fontSize: "12px", color: "var(--color-text-body)", fontWeight: "600" }}>1K USD</span>
        </div>
        ...
        <div ref={downloadRef} style={{ position: "relative" }}>
          ...
          {downloadOpen && (
            <div style={{
              ...
              >
                <FileSpreadsheet size={14} color="var(--color-success)" />
                엑셀 다운로드 (.xlsx)
              </button>
              <button
                onClick={handlePdf}
                ...
                onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = "transparent")}
              >
                <FileText size={14} color="var(--color-danger)" />
                PDF 다운로드 (.pdf)
              </button>
            </div>
          )}
