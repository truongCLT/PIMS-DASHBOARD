# Migrating web UI to 대우본사 요청-예시1

Read `artifacts/daewoo-hq-example-1/docs/AGENTS.md` and
`artifacts/daewoo-hq-example-1/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/daewoo-hq-example-1/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/daewoo-hq-example-1/lib/utils`
- `@/hooks/use-toast` → `@workspace/daewoo-hq-example-1/hooks/use-toast`
