# Consuming 대우본사 요청-예시1 in Expo apps

Read `artifacts/daewoo-hq-example-1/docs/AGENTS.md` first. React Native does
...
`artifacts/daewoo-hq-example-1/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/daewoo-hq-example-1/tokens";
...
```tsx
import { nativeTheme } from "@workspace/daewoo-hq-example-1/lib/native-theme";
import { useColors } from "@workspace/daewoo-hq-example-1/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/daewoo-hq-example-1/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/daewoo-hq-example-1/components/native/badge";
import { Button } from "@workspace/daewoo-hq-example-1/components/native/button";
import { Card } from "@workspace/daewoo-hq-example-1/components/native/card";
```
...
Import and render
`@workspace/daewoo-hq-example-1/components/native/button`, then run Expo
