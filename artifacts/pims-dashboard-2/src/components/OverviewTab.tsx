  ...
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "4px", gap: "8px" }}>
      <span style={{ display: "flex", alignItems: "baseline", gap: "6px", minWidth: 0 }}>
        ...
        {unit && <span style={{ fontSize: "11px", color: AG.mutedForeground, whiteSpace: "nowrap" }}>{unit}</span>}
      </span>
        ...
        {badgeValue != null && (
          <span
            style={{
              fontSize: "11px",
              fontWeight: 700,
              color: badgeColor ?? AG.foreground,
              backgroundColor: `${badgeColor ?? AG.foreground}14`,
              border: `1px solid ${badgeColor ?? AG.foreground}33`,
              borderRadius: "10px",
              padding: "2px 8px",
              whiteSpace: "nowrap",
            }}
    ...
    <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: "8px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: ROW_COLUMNS, gap: "8px" }}>
        ...
        <div style={cardStyle}>
          ...
          <div style={{ marginTop: "8px", borderTop: `1px solid ${AG.background}`, paddingTop: "8px" }}>
                  ...
                  return (
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                      ...
                      <div style={{ fontSize: "11px", color: "#555", marginTop: "2px", whiteSpace: "nowrap" }}>
                        {t("common:actual")} <b style={{ color: AG.foreground }}>{fmtMoney(cumRev)}</b>
        ...
        {(() => {
          ...
          const improveColor = improve == null ? AG.mutedForeground : improve >= 0 ? ACHIEVE_GREEN : ACHIEVE_RED;
          const H = 150;
                  ...
                  {stages.map((s) => {
                    ...
                    return (
                      <div key={s.key} style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column", alignItems: "center" }}>
                        <div style={{ fontSize: "16px", fontWeight: 800, color: AG.foreground, marginBottom: "2px" }}>
                          {fmtPct(pct)}
                        </div>
                        <div style={{ fontSize: "10px", color: AG.mutedForeground, marginBottom: "4px", whiteSpace: "nowrap", maxWidth: "100%", overflow: "hidden", textOverflow: "ellipsis" }}>
                        ...
                        />
                        <div style={{ fontSize: "12px", color: AG.foreground, fontWeight: 700, marginTop: "5px", whiteSpace: "nowrap", maxWidth: "100%", overflow: "hidden", textOverflow: "ellipsis" }}>
                          {s.title}
                        </div>
                      </div>
                    );
